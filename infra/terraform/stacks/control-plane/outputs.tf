...
#
# THIS STACK HAS NOW FAILED TWICE WITH THAT SIGNATURE: a plan that prints in
# full, summarises, and exits non-zero, the managed certificate's
# RequireCustomHostnameInEnvironment being the other. Read the exit code of a
# plan of this stack rather than the last line of its output.
#
