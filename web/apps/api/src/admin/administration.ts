...
//
// THE SECTIONS THIS LANE OWNS: Analytics & Usage, Admins & Permissions, and System Configuration.
//
// PERMISSION PREFIXES RESERVED FOR IT: admin.operators.*. The
...
//
// The operator directory already exists in router.ts under admin.operators and is not moved. What belongs here is usage analytics and the installation's own configuration.
//
...
/**
 * The Administration namespace, mounted at `admin.administration`.
 *
