...
with zero skipped; the 38th was added to the roster after that run. What that
does not settle is in `docs/security/pentest-readiness.md`: one cluster and one
