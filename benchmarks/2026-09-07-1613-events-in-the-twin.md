...
Run on 2026-09-07T16:13:55Z.

- Machine: darwin arm64, 8 cores, load averages: 18.34 21.31 22.10.
...
| Step | Time |
| --- | --- |
| Copy from production | 25.03s |
| Mask | 58.36s |
| Verify | 860ms |
| Whole refresh | 1m24.42s |
...
Loading production's own rows took 13.95s and is not part of any figure above; it is the fixture being built.
