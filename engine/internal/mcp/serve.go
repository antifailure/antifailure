...
func Serve(ctx context.Context, cfg Config) error {
	...
	server.Register(newRunChaosFaultsTool(project, engine, orch.injectFaults))
	...
	server.Register(newSearchDocsTool(project))
	server.Register(newListDocsTool(project))
	server.Register(newReadDocsPageTool(project))
