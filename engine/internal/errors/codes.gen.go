...
var catalog = map[Code]Entry{
	...
	AFRUN011: {
		...
		NextStep:  "A backup was written to {backup}. The database was rebuilt; run 'af down --all' to reconcile any resources it no longer tracks.",
		Docs:      "concepts/journal",
		Retryable: false,
		ExitCode:  ExitFailure,
	},
