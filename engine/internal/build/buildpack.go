...
func nodeBuildpack(fs fileSet, dir, command string, port int) (*Buildpack, bool) {
	...
	fmt.Fprintf(&b, "# Generated by Antifailure. https://antifailure.dev/docs/guides/build\n")
...
func pythonBuildpack(fs fileSet, dir, command string, port int) (*Buildpack, bool) {
	...
	var b strings.Builder
	b.WriteString("# Generated by Antifailure. https://antifailure.dev/docs/guides/build\n")
