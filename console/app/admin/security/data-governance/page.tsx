 ...
 * routes to web/apps/api/src/admin/security.ts. Nothing else in the portal
 * has to change. See console/app/admin/README.md.
 */
export default function SecurityDataGovernancePage() {
  return <PlannedSection href="/admin/security/data-governance" />;
}
