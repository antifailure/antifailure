...
// license.go. It held two maps to this tool's copies, notShipped and
// unenforced, until unenforced was emptied by gating custom roles and deleted
// with the warning it fed. It stays general because license.go says to bring
// that map back, with its checks, the day a feature is built and gated nowhere
// again, and this is the reader those checks would use.
//
