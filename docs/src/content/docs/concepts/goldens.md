...
almost certainly want [subsetting](/concepts/subsetting/) as well: a slice is
...
[subsetting](/concepts/subsetting/).
...
[subsetting](/concepts/subsetting/), [providers](/providers/overview/).
