...
The sandbox credential {name} would need a different value for each of {services}, and the egress proxy holds one value per credential for the whole environment.
