...
export function GET() {
  ...
  lines.push(
    ...
    "  namespace. Each host gets one of seven modes: BLOCK refuses with a readable",
    ...
    "  searchable inbox, MOCK answers from a stateful offline pack, EMULATE answers",
    "  from an emulator inside the environment at the provider's own hostname, with no",
    "  endpoint override in your application, and SYNTH asks a model to invent a",
