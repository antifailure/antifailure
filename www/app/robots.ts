 ...
 *  Next's build manifests. The front door for a stranger is /request-demo,
 *  which IS indexed and is the page somebody searching for this product by
 *  name is looking for.
 *
 ...
 *  paths into it. `/signup` and `/sign-up` are deliberately NOT here: both 301
 *  to /request-demo, which IS indexable, and the canonical tag on that page is
 *  what resolves the spellings into one result rather than a rule hiding one
 *  of them. */
