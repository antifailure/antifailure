  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === "white" &&
          // Button's `outlined` theme exactly: the same border, the same
          // near-transparent fill, the same hover. Three controls sat on one
          // line in three different fills, solid black, near transparent and
          // solid white, which reads as three unrelated things rather than as
          // one primary action and two alternatives. One solid, two outlined.
          "h-11 w-[34.2%] justify-between rounded-full border border-black/40 bg-black/[0.02] px-7 text-black hover:border-black max-xl:w-[300px] max-lg:w-[36%] max-lg:px-5 max-sm:w-full",
        variant === "green" &&
